...
### Run n=100 simulations for N=64, P=0.1, D=1, h=0.01 and z=0.2 -> Figure 2 

SARs <- run(64,0.1,1,0.01,0.2,100)


#Summarize the results
SARs <- aggregate(. ~ grain , data=SARs,mean,na.action = na.pass) 
...
plot (log(SARs[,6]), (SARs[,2]), axes = FALSE, type = "o", cex=0.5,lwd = 1.5,ylim=c(-0.2,1), 
...
legend(5,1, c("SAR","cSAR","linear"),lty=c(1,2,3), lwd=c(1.3,1.3,1.3),col=c("black","red","blue"),pch=c(21,22,23), bty="n",pt.bg = 'white')
